...
class StudentController extends ApiController
{
    ...
    public function uploadAvatar(
        \App\Domains\Core\Requests\Student\UploadStudentAvatarRequest $request,
        \App\Domains\Core\Actions\Student\UploadStudentAvatarAction $action
    ) {
        $student = $action->execute($request->route('id'), $request->file('avatar'));
        return $this->success(
            data: new \App\Http\Resources\V1\StudentResource($student),
