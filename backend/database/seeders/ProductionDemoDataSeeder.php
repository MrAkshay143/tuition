...
class ProductionDemoDataSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $teacherId = DB::table('users')->where('email', 'teacher@eduflow.in')->value('id');
        
        DB::table('users')->updateOrInsert(
            ['email' => 'student@eduflow.in'],
            [
                'name' => 'Bright Student',
                'password' => bcrypt('password'),
                'role' => 'student',
        ...
        $studentId = DB::table('users')->where('email', 'student@eduflow.in')->value('id');
