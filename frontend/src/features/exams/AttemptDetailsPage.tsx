  ...
  return (
    <div className="space-y-6 pb-20 sm:pb-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
        ...
        <Card className="p-3 sm:p-4 flex items-center justify-between border-l-4 border-l-amber-500">
          <div>
            <p className="text-[10px] sm:text-[11px] font-medium text-[rgb(var(--text-muted))] mb-1">Warnings</p>
            <h3 className="text-xl sm:text-2xl font-bold text-amber-500">{security.warnings_count}</h3>
          </div>
          <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-amber-500/10 text-amber-500 flex items-center justify-center">
            <ShieldAlert size={18} />
          </div>
        </Card>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-6 items-start">
        ...
        <div className="w-full lg:w-1/3 space-y-6 lg:sticky lg:top-6 flex flex-col-reverse lg:flex-col">
          ...
          <Card className="p-5">
            <h3 className="font-bold text-[rgb(var(--text-primary))] mb-4 flex items-center gap-2">
              <ShieldAlert size={18} /> Security Timeline
            </h3>
