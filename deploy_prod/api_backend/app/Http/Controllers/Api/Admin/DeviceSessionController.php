...
class DeviceSessionController extends Controller
{
    ...
    public function clearRememberTokens()
    {
        ...
        return response()->json(['message' => 'Remember-me tokens cleared across all users in database.']);
    }
    ...
    public function forcePasswordReset()
    {
        ...
        return response()->json(['message' => 'Password reset policy enforced across database.']);
    }
    ...
    public function blockSuspiciousIps()
    {
        ...
        return response()->json(['message' => 'Suspicious IP addresses blocked successfully in database firewall.']);
    }
}
