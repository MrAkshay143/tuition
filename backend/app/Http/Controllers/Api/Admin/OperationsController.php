...
class OperationsController extends ApiController
{
    ...
    public function live()
    {
        return response()->json([
            'status' => 'ok',
            'app'    => config('app.name', 'EduFlow'),
        ]);
    }

    // Service readiness check (Database, Cache, Queue)
    ...
    // Admin diagnostic details and build info
    public function details()
    {
        ...
        // Calculate security and active session telemetry
        ...
        // Recent security activity log entries
