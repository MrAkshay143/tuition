...
class DatabaseSeeder extends Seeder
{
    ...
    {
        $this->call([
            Phase3AcademicSeeder::class, // Must run first — other seeders depend on programs/subjects
            AdminSeeder::class,
            TeacherSeeder::class,
            BatchSeeder::class,
            CourseSeeder::class,
...
class BatchSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $batches = [
            ['name' => 'Class 10 - Science',     'color' => '#6C63FF', 'description' => 'Class 10 Science batch'],
            ['name' => 'NEET 2026',               'color' => '#00D4AA', 'description' => 'Medical entrance preparation'],
...
class StudentSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($students as $i => $s) {
            ...
            if ($batches->isNotEmpty()) {
                ...
                foreach ($courses as $course) {
                    \App\Domains\Learning\Models\Enrollment::updateOrCreate(
                        [
                            'user_id'   => $student->id,
                            'course_id' => $course->id,
                        ],
        ...
        echo "  ✅ " . count($students) . " students created (pass: Student@1234!)\n";
    }
}
...
class SettingsSeeder extends Seeder
{
    public function run(): void
    {
        $defaults = [
            ...
            'smtp_port'        => '2525',
            'smtp_from'        => 'noreply@eduflow.test',
            'storage_provider' => 'local',
            'fcm_server_key'   => '',
            
            // Dynamic Favicon and SEO Settings
            'favicon_url'      => '/favicon.ico',
            'seo_title'        => 'EduFlow AI - Online Tuition & Private Batch Classroom',
            ...
            'seo_keywords'     => 'online tuition, physics neet, chemistry jee, maths tuition, private batch, eduflow ai',
            ...
            'landing_hero_video_url' => 'https://www.youtube.com/embed/dQw4w9WgXcQ',
            ...
            'landing_testimonials' => json_encode([
                ['name' => 'Aarav Sharma', 'role' => 'Class 12th Student', 'quote' => 'EduFlow AI has completely changed the way I study. The concept clarity and practice questions helped me score 98% in boards!', 'initials' => 'AS', 'variant' => 'violet'],
        ...
        echo "  ✅ Default CMS settings seeded\n";
    }
}
...
class CourseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($courses as $cData) {
            ...
            $thumbnails = [
                'Physics'     => 'http://localhost:8000/images/physics_thumb.png',
                'Chemistry'   => 'http://localhost:8000/images/chemistry_thumb.png',
                'Mathematics' => 'http://localhost:8000/images/maths_thumb.png',
                'Biology'     => 'http://localhost:8000/images/biology_thumb.png',
            ];
            ...
            $course = \App\Models\Course::updateOrCreate(
                ...
                [
                    ...
                    'thumbnail'   => $thumbnails[$subjectName] ?? 'http://localhost:8000/images/default_thumb.png',
                    'status'      => 'published',
                ...
                for ($lIdx = 0; $lIdx < 5; $lIdx++) {
                    ...
                    if ($lessonNumber % 3 === 1) {
                        ...
                        $pdfMedia = \App\Domains\Media\Models\Media::create([
                            ...
                            'extension'         => 'pdf',
                            'path'              => "/materials/dummy_notes_{$lessonNumber}.pdf",
                            'filename'          => $pdfName,
                            'size_bytes'        => 1887436,
                            'size'              => 1887436,
                            'uploaded_by'       => $teacher->id,
