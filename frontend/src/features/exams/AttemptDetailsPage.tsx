  ...
  return (
    <div className="space-y-6 pb-20 sm:pb-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <Card className="p-4 flex items-center justify-between">
          <div>
            <p className="text-[11px] font-medium text-[rgb(var(--text-muted))] mb-1">Security Warnings</p>
            <h3 className="text-2xl font-bold text-amber-500">{security.warnings_count}</h3>
          </div>
